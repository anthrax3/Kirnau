namespace Kirnau.Survey.Admin.Tests.Area.Survey
{
    using System.Linq;
    using System.Web.Mvc;
    using System.Web.Routing;
    using Microsoft.VisualStudio.TestTools.UnitTesting;
    using Kirnau.Survey.Admin.Areas.Survey;
    ...
    public class SurveyAreaRegistrationFixture
    {
        ...
        public void RegisterMySurveysRoute()
        {
            ...
            var route = areaRegistrationContext.Routes.Cast<Route>().SingleOrDefault(r =>
                    string.Equals(r.Url, "survey/{tenant}", System.StringComparison.OrdinalIgnoreCase) &&
        ...
        public void RegisterNewSurveyRoute()
        {
            ...
            var route = routes.Cast<Route>().SingleOrDefault(r =>
                    string.Equals(r.Url, "survey/{tenant}/newsurvey", System.StringComparison.OrdinalIgnoreCase) &&
                    string.Equals(r.Defaults["controller"] as string, "Surveys", System.StringComparison.OrdinalIgnoreCase) &&
        ...
        public void RegisterAnalyzeSurveyRoute()
        {
            ...
            var route = routes.Cast<Route>().SingleOrDefault(r =>
                    string.Equals(r.Url, "survey/{tenant}/{surveySlug}/analyze", System.StringComparison.OrdinalIgnoreCase) &&
                    string.Equals(r.Defaults["controller"] as string, "Surveys", System.StringComparison.OrdinalIgnoreCase) &&
        ...
        public void RegisterExportSurveyResponsesRoute()
        {
            ...
            var route = routes.Cast<Route>().SingleOrDefault(r =>
                    string.Equals(r.Url, "survey/{tenant}/{surveySlug}/analyze/export", System.StringComparison.OrdinalIgnoreCase) &&
                    string.Equals(r.Defaults["controller"] as string, "Surveys", System.StringComparison.OrdinalIgnoreCase) &&
        ...
        public void RegisteDeleteSurveyRoute()
        {
            ...
            var route = routes.Cast<Route>().SingleOrDefault(r =>
                    string.Equals(r.Url, "survey/{tenant}/{surveySlug}/delete", System.StringComparison.OrdinalIgnoreCase) &&
                    string.Equals(r.Defaults["controller"] as string, "Surveys", System.StringComparison.OrdinalIgnoreCase) &&
        ...
        public void RegisteAddQuestionRoute()
        {
            ...
            var route = routes.Cast<Route>().SingleOrDefault(r =>
                    string.Equals(r.Url, "survey/{tenant}/newquestion/add", System.StringComparison.OrdinalIgnoreCase) &&
                    string.Equals(r.Defaults["controller"] as string, "Surveys", System.StringComparison.OrdinalIgnoreCase) &&
        ...
        public void RegisteCancelNewQuestionRoute()
        {
            ...
            var route = routes.Cast<Route>().SingleOrDefault(r =>
                    string.Equals(r.Url, "survey/{tenant}/newquestion/cancel", System.StringComparison.OrdinalIgnoreCase) &&
                    string.Equals(r.Defaults["controller"] as string, "Surveys", System.StringComparison.OrdinalIgnoreCase) &&
