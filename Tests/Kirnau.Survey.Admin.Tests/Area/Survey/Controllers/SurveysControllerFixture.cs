namespace Kirnau.Survey.Admin.Tests.Area.Survey.Controllers
{
    ...
    using Moq;
    using Kirnau.Survey.Admin.Areas.Survey.Controllers;
    using Kirnau.Survey.Admin.Areas.Survey.Models;
    ...
    public class SurveysControllerFixture
    {
        ...
        public void DeleteCallsDeleteSurveyAnswersStore()
        {
            ...
            using (var controller = new SurveysController(new Mock<ISurveyStore>().Object, mockSurveyAnswerStore.Object, new Mock<ISurveyAnswersSummaryStore>().Object, null, null, null))
            {
                controller.Delete("tenant", "survey-slug");
            }
